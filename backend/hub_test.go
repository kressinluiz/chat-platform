...
func (m *MockRoomRepository) Create(ctx context.Context, name string) (Room, error) {
	return Room{ID: "test-room-id", Name: name}, nil
}

func (m *MockRoomRepository) List(ctx context.Context) ([]Room, error) {
	return []Room{{ID: "test-room-id", Name: "general"}, {ID: "other-room-id", Name: "general"}}, nil
}
...
func (mock *MockMessageRepository) GetHistory(ctx context.Context, roomID string, limit int) ([]StoredMessage, error) {
